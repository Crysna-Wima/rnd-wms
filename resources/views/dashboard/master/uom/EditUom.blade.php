			...
			<div class="card-body">
				...
				<form action="/uom/update" method="post">
					...
					<div class="mb-3">
						...
						<input type="text" class="form-control" name="code" required="required" placeholder="code" value="{{ $item->code }}" maxlength="5">
					</div>
					<div class="mb-3">
						...
						<div class="modal-footer">
							<a href="/uom" class="btn btn-secondary">Kembali</a>
